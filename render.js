...
var renderFile = function (file, argsObject) {
  if (file) {
    ...
    <head>
      <base target="_top">
      <meta charset="utf-8">
      <meta name="renderFile" content="SIPOC Render File Function">
...
`);
  ...
  <html id="renderTemplate">
    <head>
      <base target="_top">
      <meta charset="UTF-8">
      <meta name="renderTemplate" content="SIPOC Render Template Function">
      <meta name=viewport content="width=device-width, initial-scale=1">
      <link href="https://fonts.googleapis.com/css?family=Acme" rel="stylesheet">
  ...
  <div id="rndnewdiv"></div>
    ...
    <script id="sipocRenderTemplateScript">
...
var appList = function (e) {
  ...
  <html id="appList">
    <head>
      <base target="_top">
      <meta charset="utf-8">
      <meta name="appList" content="SIPOC Function List">
      <meta name=viewport content="width=device-width, initial-scale=1">
      <link href="https://fonts.googleapis.com/css?family=Acme" rel="stylesheet">
    </head>
    <body>
